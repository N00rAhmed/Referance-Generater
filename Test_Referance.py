...
class TestReferenceProgram(unittest.TestCase):
    ...
    def test_main_function(self, mock_print, mock_input):
        main()
        expected_reference = 'Sample Header (2022) Why Apple Is Still A Great Marketer And What You Can Learn [online] Address: https://www.forbes.com/sites/christinemoorman/2018/01/12/why-apple-is-still-a-great-marketer-and-what-you-can-learn/?sh=3f9c8c8315bd [accessed: 20/01/2024] '
